...
$DATA ./NMsimData_xgxr021_known_01.csv
IGN=@
...
$SIMULATION  (1955855168) 

$ETAS FILE=xgxr021_known_01_input.phi FORMAT=s1pE15.8 TBLN=1
$ESTIMATION  MAXEVAL=0 NOABORT METHOD=1 INTERACTION FNLETA=2

$TABLE PRED IPRED NOPRINT NOAPPEND FILE=xgxr021_known_01.tab
