...
#Created 2023-11-03 at 19:39

xpose.runno <- '025.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/philip/wdirs/NMsim/tests/testthat/testData/nonmem/xgxr025.dir5/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.36.0/PsN_5_3_1/R-scripts' # This is not used
raw.results.file <- 'raw_results_xgxr025.csv'
...
omega.fixed <- c(FALSE,TRUE,TRUE,TRUE,TRUE)
