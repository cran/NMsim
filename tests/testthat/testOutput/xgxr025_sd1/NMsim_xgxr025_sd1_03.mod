...
$TABLE      ROW KA V3 Q NOHEADER FIRSTONLY FILE=NMsim_xgxr025_sd1_03_1.tab
$TABLE      ROW KA V2 CL ONEHEADER FIRSTONLY FILE=NMsim_xgxr025_sd1_03_2.tab
$TABLE      ROW ID DV PRED IPRED FILE=NMsim_xgxr025_sd1_03_3.tab
