...
$TABLE      ROW KA V3 Q NOHEADER FIRSTONLY FILE=NMsim_xgxr025_sd1_10_1.tab
$TABLE      ROW KA V2 CL ONEHEADER FIRSTONLY FILE=NMsim_xgxr025_sd1_10_2.tab
$TABLE      ROW ID DV PRED IPRED FILE=NMsim_xgxr025_sd1_10_3.tab
