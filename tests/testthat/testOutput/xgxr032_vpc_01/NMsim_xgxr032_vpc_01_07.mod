...
$DATA       NMsimData_xgxr032_vpc_01.csv IGNORE=@ IGNORE=(FLAG.NE.0)
            IGNORE(DOSE.LT.30)
...
$SIMULATION ONLYSIM (1458358178) 

$TABLE ROW PRED IPRED Y NOPRINT NOAPPEND FILE=NMsim_xgxr032_vpc_01_07.tab
