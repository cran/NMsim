...
#Created 2023-09-09 at 14:43

xpose.runno <- '022.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/philip/wdirs/NMsim/inst/examples/nonmem/xgxr022.dir1/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.36.0/PsN_5_3_1/R-scripts' # This is not used
raw.results.file <- 'raw_results_xgxr022.csv'
theta.labels <- c('POPKA','POPV2','POPCL','POPV3','TVQ')
theta.fixed <- c(FALSE,FALSE,FALSE,FALSE,FALSE)
omega.labels <- c('OMEGA(1,1)','OMEGA(2,2)','OMEGA(3,2)','OMEGA(3,3)','OMEGA(4,4)','OMEGA(5,5)')
omega.fixed <- c(TRUE,FALSE,FALSE,FALSE,TRUE,TRUE)
